...
//
// Three secrets exist per accelerator and ALL of them are per workspace (guide §7.3):
...
const FIELDS = new Set(['provisioning_key', 'provisioning_key_id', 'sso_key', 'invite_code']);
