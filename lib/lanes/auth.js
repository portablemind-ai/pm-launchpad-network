...
function createAuthLane({ pm, sessions, store, config }) {
  ...
  async function login(req, res) {
    ...
    if (body.mfa_enrollment_required) {
      throw new HttpError(403, 'Your workspace requires two-factor authentication. Ask your administrator to help you set it up, then sign in here.', { mfa_enrollment_required: true });
    }
